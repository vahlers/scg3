/**
 * \file simple_gouraud_clipping_vert.glsl
...
void main() {
  ...
  // test clipping plane
  vec4 clipPlane = vec4(normalize(vec3(1., 1., 0.)), 0.4);   // (nx, ny, nz, d)
  gl_ClipDistance[0] = dot(vVertex.xyz, clipPlane.xyz) + clipPlane.w;
}
